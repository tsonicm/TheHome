// If the current page is selected, the text color will be white and the background color will be slate-400
// If the current page is not selected, the text color will be black and the background color will be white
...
export function Navbar({currentPage}: {currentPage: string}) {
    ...
    return (
    <nav class="absolute bottom-[15px] left-0 right-0 mx-auto w-fit flex justify-center items-center px-4 py-2 bg-white shadow-md rounded-lg">
